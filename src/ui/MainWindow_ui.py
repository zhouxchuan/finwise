...
"}")
        ...
        self.actionSyncFundHistory = QAction(mainWindow)
        self.actionSyncFundHistory.setObjectName(u"actionSyncFundHistory")
        self.actionSyncFundHistory.setEnabled(False)
        icon4 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.MediaPlaylistRepeat))
        self.actionSyncFundHistory.setIcon(icon4)
        self.actionSetupFundAccount = QAction(mainWindow)
        self.actionSetupFundAccount.setObjectName(u"actionSetupFundAccount")
        self.actionSetupFundAccount.setEnabled(False)
        icon5 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.DocumentProperties))
        self.actionSetupFundAccount.setIcon(icon5)
        self.actionAnalyzeIndex = QAction(mainWindow)
        self.actionAnalyzeIndex.setObjectName(u"actionAnalyzeIndex")
        self.actionAnalyzeIndex.setEnabled(False)
        self.actionTradeFund = QAction(mainWindow)
        self.actionTradeFund.setObjectName(u"actionTradeFund")
        self.actionTradeFund.setEnabled(False)
        icon6 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.MediaPlaylistShuffle))
        self.actionTradeFund.setIcon(icon6)
        self.actionCreateFundAccount = QAction(mainWindow)
        self.actionCreateFundAccount.setObjectName(u"actionCreateFundAccount")
        self.actionCreateFundAccount.setEnabled(False)
        icon7 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.ListAdd))
        self.actionCreateFundAccount.setIcon(icon7)
        self.actionDeleteFundAccount = QAction(mainWindow)
        self.actionDeleteFundAccount.setObjectName(u"actionDeleteFundAccount")
        self.actionExecuteTradeData = QAction(mainWindow)
        self.actionExecuteTradeData.setObjectName(u"actionExecuteTradeData")
        self.actionExecuteTradeData.setEnabled(False)
        self.actionRemoveFundAccount = QAction(mainWindow)
        self.actionRemoveFundAccount.setObjectName(u"actionRemoveFundAccount")
        self.actionRemoveFundAccount.setEnabled(False)
        icon8 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.ListRemove))
        self.actionRemoveFundAccount.setIcon(icon8)
        self.actionSetupOptions = QAction(mainWindow)
        self.actionSetupOptions.setObjectName(u"actionSetupOptions")
        ...
        icon9 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.EditSelectAll))
        self.fundAccountInitButton.setIcon(icon9)
        ...
        self.tradeTableWidget = QTableWidget(self.rightWidget)
        if (self.tradeTableWidget.columnCount() < 3):
            self.tradeTableWidget.setColumnCount(3)
        if (self.tradeTableWidget.rowCount() < 3):
            self.tradeTableWidget.setRowCount(3)
        self.tradeTableWidget.setObjectName(u"tradeTableWidget")
        sizePolicy5 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        sizePolicy5.setHorizontalStretch(3)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.tradeTableWidget.sizePolicy().hasHeightForWidth())
        self.tradeTableWidget.setSizePolicy(sizePolicy5)
        self.tradeTableWidget.setMinimumSize(QSize(0, 100))
        self.tradeTableWidget.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.tradeTableWidget.setAlternatingRowColors(True)
        self.tradeTableWidget.setSelectionMode(QAbstractItemView.SelectionMode.SingleSelection)
        self.tradeTableWidget.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        self.tradeTableWidget.setGridStyle(Qt.PenStyle.DotLine)
        self.tradeTableWidget.setRowCount(3)
        self.tradeTableWidget.setColumnCount(3)
        self.tradeTableWidget.verticalHeader().setVisible(False)

        self.horizontalLayout_2.addWidget(self.tradeTableWidget)
        ...
        self.menuFile.addAction(self.actionCreateFundAccount)
        self.menuFile.addAction(self.actionRemoveFundAccount)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionExit)
        self.menuHelp.addAction(self.actionAbout)
        self.menuTool.addAction(self.actionSetupFundAccount)
        self.menuTool.addAction(self.actionSyncFundHistory)
        self.menuTool.addSeparator()
        self.menuTool.addAction(self.actionSetupOptions)
        self.menu.addAction(self.actionExecuteTradeData)
        ...
        self.actionSyncFundHistory.triggered.connect(mainWindow.onActionSyncFundHistoryTriggered)
        self.actionSetupFundAccount.triggered.connect(mainWindow.onActionSetupFundAccountTriggered)
    ...
    def retranslateUi(self, mainWindow):
...
#endif // QT_CONFIG(tooltip)
        self.actionSyncFundHistory.setText(QCoreApplication.translate("mainWindow", u"\u66f4\u65b0\u57fa\u91d1\u6570\u636e(&R)...", None))
        self.actionSyncFundHistory.setIconText(QCoreApplication.translate("mainWindow", u"\u66f4\u65b0\u57fa\u91d1\u6570\u636e", None))
#if QT_CONFIG(tooltip)
        self.actionSyncFundHistory.setToolTip(QCoreApplication.translate("mainWindow", u"\u66f4\u65b0\u57fa\u91d1\u6570\u636e", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionSyncFundHistory.setShortcut(QCoreApplication.translate("mainWindow", u"Alt+S", None))
#endif // QT_CONFIG(shortcut)
        self.actionSetupFundAccount.setText(QCoreApplication.translate("mainWindow", u"\u914d\u7f6e\u57fa\u91d1\u8d26\u6237(&S)...", None))
        self.actionSetupFundAccount.setIconText(QCoreApplication.translate("mainWindow", u"\u914d\u7f6e\u57fa\u91d1\u8d26\u6237", None))
#if QT_CONFIG(tooltip)
        self.actionSetupFundAccount.setToolTip(QCoreApplication.translate("mainWindow", u"\u914d\u7f6e\u57fa\u91d1\u8d26\u6237", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionSetupFundAccount.setShortcut(QCoreApplication.translate("mainWindow", u"Alt+S", None))
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(tooltip)
        self.actionCreateFundAccount.setText(QCoreApplication.translate("mainWindow", u"\u521b\u5efa\u57fa\u91d1\u8d26\u6237...", None))
        self.actionDeleteFundAccount.setText(QCoreApplication.translate("mainWindow", u"\u5220\u9664\u57fa\u91d1\u8d26\u6237", None))
        self.actionExecuteTradeData.setText(QCoreApplication.translate("mainWindow", u"\u6279\u91cf\u5904\u7406\u4ea4\u6613\u6570\u636e...", None))
        self.actionRemoveFundAccount.setText(QCoreApplication.translate("mainWindow", u"\u5220\u9664\u57fa\u91d1\u8d26\u6237", None))
        self.actionSetupOptions.setText(QCoreApplication.translate("mainWindow", u"\u8bbe\u7f6e\u9009\u9879(&O)...", None))
        self.actionSetupOptions.setIconText(QCoreApplication.translate("mainWindow", u"\u8bbe\u7f6e\u9009\u9879", None))
#if QT_CONFIG(tooltip)
        self.actionSetupOptions.setToolTip(QCoreApplication.translate("mainWindow", u"\u8bbe\u7f6e\u9009\u9879", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionSetupOptions.setShortcut(QCoreApplication.translate("mainWindow", u"Alt+O", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.fundNVDateLabel.setText(QCoreApplication.translate("mainWindow", u"N/A", None))
