...
"}")
        ...
        icon8 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.EditSelectAll))
        self.fundAccountInitButton.setIcon(icon8)
        ...
        self.menuFile.addAction(self.actionSetupFundAccount)
        self.menuFile.addSeparator()
        ...
        self.actionDeleteFundAccount.triggered.connect(mainWindow.onActionDeleteFundAccountTriggered)
...
#endif // QT_CONFIG(tooltip)
        self.actionSyncFundHistory.setText(QCoreApplication.translate("mainWindow", u"\u6570\u636e\u66f4\u65b0(&R)...", None))
        self.actionSyncFundHistory.setIconText(QCoreApplication.translate("mainWindow", u"\u6570\u636e\u66f4\u65b0", None))
#if QT_CONFIG(tooltip)
        self.actionSyncFundHistory.setToolTip(QCoreApplication.translate("mainWindow", u"\u6570\u636e\u66f4\u65b0...", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
