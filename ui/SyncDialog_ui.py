...
class Ui_SyncDialog(object):
    def setupUi(self, SyncDialog):
        ...
        SyncDialog.resize(733, 462)
        SyncDialog.setMinimumSize(QSize(0, 0))
        SyncDialog.setStyleSheet(u"")
        self.verticalLayout = QVBoxLayout(SyncDialog)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.horizontalLayout_2 = QHBoxLayout()
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.listWidget = QListWidget(SyncDialog)
        ...
        self.cancelButton.clicked.connect(SyncDialog.reject)
        self.syncButton.clicked.connect(SyncDialog.onSyncButtonClicked)
        self.listWidget.itemSelectionChanged.connect(SyncDialog.onItemSelectionChanged)

        QMetaObject.connectSlotsByName(SyncDialog)
    # setupUi

    def retranslateUi(self, SyncDialog):
        SyncDialog.setWindowTitle(QCoreApplication.translate("SyncDialog", u"\u6570\u636e\u540c\u6b65", None))
        self.processTip1.setText(QCoreApplication.translate("SyncDialog", u"\u540c\u6b65\u57fa\u672c\u6570\u636e...", None))
        self.processTip3.setText(QCoreApplication.translate("SyncDialog", u"\u66f4\u65b0\u5386\u53f2\u6570\u636e...", None))
        self.processTip2.setText(QCoreApplication.translate("SyncDialog", u"\u66f4\u65b0\u6240\u6240\u6709\u5386\u53f2\u6570\u636e...", None))
        self.syncButton.setText(QCoreApplication.translate("SyncDialog", u"\u66f4\u65b0", None))
        self.cancelButton.setText(QCoreApplication.translate("SyncDialog", u"\u53d6\u6d88", None))
    # retranslateUi
